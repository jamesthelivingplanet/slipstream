...
export const icons = {
  folder: svg('<path d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.9a2 2 0 0 1-1.69-.9L9.6 3.9A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13c0 1.1.9 2 2 2Z"/>', 12),
  gitBranch: svg('<line x1="6" y1="3" x2="6" y2="15"/><circle cx="18" cy="6" r="3"/><circle cx="6" cy="18" r="3"/><path d="M18 9a9 9 0 0 1-9 9"/>', 12),
  ...
  terminal: svg('<path d="m7 8 4 4-4 4M13 16h4"/><rect x="2" y="3" width="20" height="18" rx="2"/>', 22),
  externalLink: svg('<path d="M15 3h6v6M10 14 21 3M18 13v6a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V8a2 2 0 0 1 2-2h6"/>'),
  ...
  sun: svg('<circle cx="12" cy="12" r="4"/><path d="M12 2v2M12 20v2M4.9 4.9l1.4 1.4M17.7 17.7l1.4 1.4M2 12h2M20 12h2M4.9 19.1l1.4-1.4M17.7 6.3l1.4-1.4"/>', 14),
  ...
  remote: svg('<path d="M2 8C2 5.8 3.8 4 6 4h12c2.2 0 4 1.8 4 4v8c0 2.2-1.8 4-4 4H6c-2.2 0-4-1.8-4-4"/><path d="M2 14.5A6.5 6.5 0 0 1 8.5 21"/><path d="M2 17.5A3.5 3.5 0 0 1 5.5 21"/><circle cx="2" cy="21" r="1"/>'),
