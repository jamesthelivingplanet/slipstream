...
export const SLIPSTREAM_COMMANDS: readonly SlipstreamCommandSpec[] = [
  ...
  {
    command: 'new-agent',
    invocation: 'slipstream new-agent',
    synopsis: 'new-agent --repo <org/name> --title <t>',
    usageCont: '[--prompt <p>] [--agent <kind>] [--json]',
    requiredCell: '`--repo`, `--title`',
    optionalCell: '`--prompt`, `--agent`, `--json`',
    effect: 'spawns a new agent in its own worktree and prints its session id',
  },
  {
    command: 'repos',
    invocation: 'slipstream repos',
    synopsis: 'repos [--json]',
    requiredCell: '—',
    optionalCell: '`--json`',
    effect: 'lists repositories you can spawn agents in',
  },
  {
    command: 'agents',
